...
class Mageho_Atos_Model_Method_3xcb extends Mageho_Atos_Model_Method_Abstract
{
    protected $_code  = Mageho_Atos_Model_Config::METHOD_ATOS_SIPS_PAYMENT_3XCB;
    protected $_formBlockType = 'atos/3xcb_form';
	protected $_infoBlockType = 'atos/3xcb_info';
    ...
    {
        return Mage::getUrl('atos/payment_3xcb/normal', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('atos/payment_3xcb/cancel', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('atos/payment_3xcb/automatic', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('atos/payment_3xcb/redirect', array('_secure' => true));
    }
}