...
class Mageho_Atos_Block_3xcb_Redirect extends Mage_Core_Block_Template
{
    /**
     * Payment method code
     * @var string
    ...
    {
		$this->_model = Mage::getModel('atos/method_3xcb');
		...
		if ($this->_model->getError()) 
		{
			...
			$this->setSystemFormUrl($this->_model->getSystemUrl())
				...
				->setTemplate('mageho/atos/3xcb/redirect.phtml');
    ...
    public function get3xcbPaymentModel()
    {
	    return $this->_model;
    }
}