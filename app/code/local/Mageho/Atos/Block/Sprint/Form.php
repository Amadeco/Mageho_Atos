...
class Mageho_Atos_Block_Sprint_Form extends Mage_Payment_Block_Form
{
    /**
     * Payment method code
     * @var string
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setTemplate('mageho/atos/sprint/form.phtml');
        
        if ($this->_config->getMethodCardIcon()) {
	        $mark = Mage::getConfig()->getBlockClassName('core/template');
	        $mark = new $mark;
	        $mark->setTemplate('mageho/atos/sprint/mark.phtml')
