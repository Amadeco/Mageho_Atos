...
class Mageho_Atos_Block_Sprint_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
	{
        parent::_construct();
        $this->setTemplate('mageho/atos/sprint/info.phtml');
    }
	...
	{
		return $this->getMethod()->getConfig()->getMethodCardIcon();
	}
}